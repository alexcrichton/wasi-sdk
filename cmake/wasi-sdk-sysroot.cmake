...
function(define_libcxx_sub target target_suffix extra_target_flags extra_libdir_suffix)
  ...
  if (WASI_SDK_EXCEPTIONS)
    # TODO: why does pic need to be turned off? Seemingly weird build things
    # that I can't figure out, but it's probably not the hardest thing in the
    # world to figure out.
    set(pic OFF)
  ...
  ExternalProject_Add(libcxx-${target}${target_suffix}-build
    ...
    PATCH_COMMAND
      ${CMAKE_COMMAND} -E chdir .. bash -c
        "git apply ${CMAKE_SOURCE_DIR}/a.patch || git apply ${CMAKE_SOURCE_DIR}/a.patch -R --check"
  )
endfunction()
